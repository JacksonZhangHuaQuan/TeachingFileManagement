            ...
            <ul class="nav" id="main-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse in">
                        <li>
                            <a class="active-menu" href="${ctx}/jsp/main/grade_add.jsp"><i class="fa fa-coffee"></i>录入成绩</a>
                        </li>
                        <li>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <form role="form" enctype="multipart/form-data" action="/grade" method="post">
                            ...
                            <div class="form-group">
                                <label>班级</label>
                                <input class="form-control" type="text" name="teachClass">
                            </div>
                            <div class="form-group">
                                <label>课程</label>
