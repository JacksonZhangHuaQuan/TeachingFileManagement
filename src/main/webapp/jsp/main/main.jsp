...
<div id="wrapper">
    <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="${ctx}/jsp/main/main.jsp">教师教学档案管理系统</a>
        </div>
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu" href="${ctx}/jsp/main/main.jsp"><i class="fa fa-dashboard "></i>主页</a>
                </li>
                <li>
...
<div id="footer-sec">
    Teachers' teaching archives management system-2019
</div>
<!-- /. FOOTER  -->
