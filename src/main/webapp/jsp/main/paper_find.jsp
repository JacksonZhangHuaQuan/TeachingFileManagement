            ...
            <ul class="nav" id="main-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse in ">
                        ...
                        <li>
                            <a href="${ctx}/jsp/main/paper_find.jsp" class="active-menu" ><i class="fa fa-bell "></i>论文查询</a>
                        </li>
                    </ul>
                </li>
                <li>
        ...
        <div class="modal-content" style="width: 1000px;  height:620px; margin-left: -30%;">
            ...
            <div class="modal-body">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <form role="form" enctype="multipart/form-data" action="/paperupdate" method="post">
...
<script>
    ...
    function deleted(id){
        ...
        $.ajax({
            type:"post",
            url:'${ctx}/paperdelete/'+id,
            async:false,
            dataType:"json",
            success: function (result) {
                location.href = '${ctx}/jsp/main/paper_find.jsp';
            },
